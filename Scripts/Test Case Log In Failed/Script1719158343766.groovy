...
WebUI.setEncryptedText(findTestObject('Form_LogIn/Input_password', [('') : GlobalVariable.password]), 'myXYx4TQCNY=')

WebUI.click(findTestObject('Form_LogIn/button_Log in'))

WebUI.waitForAlert(1000, FailureHandling.STOP_ON_FAILURE)
